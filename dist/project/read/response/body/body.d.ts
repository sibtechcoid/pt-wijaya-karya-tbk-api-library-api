...
export default interface Body<MemberStatus, ProjectStatus, Group, P extends Position<any, Group>, M extends Omit<Member<MemberStatus, any, Group, P>, 'access'>, O extends Object<Name & Abbreviation> = Object<Name & Abbreviation>> extends Record, BaseBody, Id, Schedule {
