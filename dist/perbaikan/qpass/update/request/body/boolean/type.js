...
function Type(value) {
    ...
    let sort = {
        ...
        tindakan: (v) => undefinable_1.default(v, type_2.default),
        analisis: (v) => undefinable_1.default(v, type_2.default),
        perbaikan: (v) => undefinable_1.default(v, compatible_1.default),
        closing: (v) => undefinable_1.default(v, (v) => array_of_1.default(v, type_2.default)),
        ...
        keputusan: (v) => type_3.default(v, keputusan_1.default),
        selesai: (v) => undefinable_1.default(v, compatible_1.default),
        /**
         * remark
         */
        ditutup: (v) => undefinable_1.default(v, type_4.default),
        catatan: (v) => undefinable_1.default(v, type_2.default),
        remark: (v) => undefinable_1.default(v, type_2.default),
    };
