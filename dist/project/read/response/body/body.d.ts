...
export default interface Body<P extends Omit<Position<any>, 'access'>, M extends Omit<Member<any, P>, 'access'>, O extends Object<Name & Abbreviation> = Object<Name & Abbreviation>> extends Record, BaseBody, Id, Schedule {
    object: O;
    members: M[];
}
